...
ИНСТРУКЦИИ:
1. Для абсолютно каждого товара определите ВСЕ подходящие группы (XX.XX.X)
...
7. Очень внимательно и подробно изучи все категории!
8. Старайся искать соответствия по возрастанию кол-ва цифр, каждая последующая цифра уточняет категорию
